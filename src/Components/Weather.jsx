...
let temp = props.weatherData?.main?.temp
  ...
  const weatherMain = props.weatherData?.weather?.[0]?.main;
    ...
    return (
        ...
        <div className='weather flex flex-col gap-6 lg:gap-12 mt-4 lg:mt-4 '>
            <div className='w-full border-4 border-emerald-500 rounded-3xl p-5 sm:p-8 flex justify-between gap-2'>
                <div className="leftdata w-fit flex flex-col items-center ">
                    <h2 className='whitespace text-4xl lg:text-6xl'>{props.weatherData.name}</h2>
                ...
                <div className="rightdata  w-fit flex items-center">
                    <img className='h-25 sm:h-30 w-30 lg:h-50 lg:w-50' src={`/Condition/${weatherMain}.png`} alt={props.weatherData?.weather?.[0]?.main} />
                </div>
            </div>
            <div className='aircondition border-4 border-emerald-500 rounded-3xl p-5 lg:p-8'>
